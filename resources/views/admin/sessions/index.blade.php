                    ...
                    <li>
                        <div class="flex items-center justify-between gap-3 rounded-lg py-3 pl-2 pr-2 hover:bg-cream">
                            <a :href="session.url" class="flex min-w-0 flex-1 items-center gap-2">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 shrink-0 text-muted-strong" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" aria-hidden="true">
